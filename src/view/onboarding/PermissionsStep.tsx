...
import meteoricLogo from '../../../src-tauri/icons/128x128.png';
          ...
          <StepCard active={!accessibilityGranted} done={accessibilityGranted}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: '#6b6660', lineHeight: 1.5 }}>
                Lets Meteoric respond to activator key (<KeyChip label="⌃" />
                <KeyChip label="⌃" />)
              </div>
            </div>
            ...
            {screenGranted && (
              <>
                <CTAButton
                  ...
                  aria-label="Quit and Reopen Meteoric"
                >
                  Quit & Reopen Meteoric
                </CTAButton>
                <p
                  style={{
                    textAlign: 'center',
