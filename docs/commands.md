...
**Behavior:** The screenshot is taken the moment you press Enter. Meteroic's own window is excluded from the capture: no flicker, no hide. The image appears in your message bubble exactly like a pasted screenshot.
...
**Permission:** Requires Screen Recording permission. On first use, macOS will prompt you to grant it. If denied, Meteroic cannot capture the screen. Grant access in System Settings > Privacy & Security > Screen Recording.
