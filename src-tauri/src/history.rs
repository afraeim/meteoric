...
use crate::commands::{ChatMessage, ConversationHistory, ModelConfigState, SystemPrompt};
use crate::database;
...
pub async fn generate_title(
    ...
    let active_model = model_config.0.lock().map_err(|e| e.to_string())?.active.clone();
